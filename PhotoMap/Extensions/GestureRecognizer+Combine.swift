//
//  GestureRecognizer+Combine.swift
//  PhotoMap
//
//  Created by Dzmitry Makarevich on 4/30/21.
//
...
extension UIView {
    ...
    func allGestures() -> Publishers.MergeMany<GesturePublisher> {
        Publishers.MergeMany(gesture(),
                             gesture(.edge()),
                             gesture(.longPress()),
                             gesture(.pan()),
                             gesture(.pinch()),
